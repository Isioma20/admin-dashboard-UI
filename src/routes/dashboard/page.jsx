...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-col gap-y-4 ">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div className="card">
          <div className="card-header">
            <div className="rounded-lg w-fit bg-blue-500/20 text-blue-500 transition-colors dark:bg-blue-600/20 dark:text-blue-600">
              <Package size={26} />
            </div>
      ...
      <div className="grid grid-cols-1 gao-4 md:grid-cols-2 lg:grid-cols-7">
